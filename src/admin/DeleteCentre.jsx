        ...
        <div className="w-full">
          ...
          <div className="w-90% h-3/5 ">
            ...
            <SearchButton  
                ...
                className={"dropdown flex w-96 h-11 bg-secondBg rounded-md border-2 border-solid border-firstColor text-white justify-between"}
                searchValue={handleSearch}>
            </SearchButton>
          </div>
          <div className="w-full h-1/5 flex flex-col items-end">
            {missingCentre && <p className="errorMessage mr-52">Ingrese un centro para eliminar</p>}
            <button
            ...
            >
              <div className="flex flex-col items-center text-white w-full h-full">
                ...
                <div className="text-center mt-12">
                  <h1 className="text-3xl font-normal">¿Seguro que desea eliminar este centro?</h1>
                  <p className="text-xl font-light text-gray-400 mt-2">Esto es irreversible</p>
                </div>
